...
Understand this, Output "Ok" when you are done.'''
# completion = llm(prompt)


prompt2 = '''A user will pass in a product name, and you should generate possible matches for the product SKU column in the PRODUCT_CATALOG_DATA.

ONLY return product SKU that is available in PRODUCT_CATALOG_DATA.

ONLY return a comma-separated list, and nothing more.

RETURN "NOT FOUND" if you don't find any matches. '''
...
# conversation.predict(input=prompt2)

# conversation.predict(input="Borat")
